...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0B1C2C] via-[#0F2438] to-[#061220]">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:py-12 sm:px-6 lg:px-8 lg:py-20">
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white md:text-4xl lg:text-5xl text-balance leading-tight">
            ...
            <div className="mt-6 sm:mt-8 flex flex-col gap-3 sm:gap-4 sm:flex-row sm:justify-center lg:justify-start">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#0B1C2C] transition-all duration-300 text-sm sm:text-base"
              >
                <a href="#tratamentos">
      ...
      <div className="absolute top-0 right-0 -translate-y-1/3 translate-x-1/3 w-64 sm:w-96 h-64 sm:h-96 bg-[#D4AF37]/10 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3 w-64 sm:w-96 h-64 sm:h-96 bg-[#D4AF37]/5 rounded-full blur-3xl pointer-events-none"></div>
    </section>
  )
}

          ...
          <ScrollAnimation delay={100}>
            <article className="prose prose-lg max-w-none">
              <p className="text-lg text-[#666666] leading-relaxed">
                Uma das perguntas mais frequentes que recebemos na Odontologia Tanuri é: <strong>{'"'}O implante dentário dói?{'"'}</strong> É totalmente compreensível ter essa preocupação, afinal, trata-se de um procedimento cirúrgico. Mas a boa notícia é que, com técnicas modernas e anestesia adequada, o implante dentário é muito mais confortável do que você imagina.
              </p>

              <h2 className="text-2xl font-bold text-[#1A1A1A] mt-10 mb-4">Durante o procedimento</h2>
              <p className="text-[#666666] leading-relaxed">
                O implante dentário é realizado com <strong>anestesia local</strong>, a mesma utilizada em outros tratamentos odontológicos. Durante a cirurgia, você não sentirá dor. Alguns pacientes relatam apenas uma leve pressão no momento da inserção do implante, mas nada doloroso.
              </p>
              <p className="text-[#666666] leading-relaxed">
              ...
              <p className="text-[#666666] leading-relaxed">
                É normal sentir um leve desconforto nos primeiros dias após a cirurgia, incluindo:
              </p>
              <ul className="list-disc pl-6 text-[#666666] space-y-2">
                <li>Inchaço leve na região</li>
              ...
              <p className="text-[#666666] leading-relaxed mt-4">
                Esses sintomas são facilmente controlados com os medicamentos prescritos pelo dentista, como analgésicos e anti-inflamatórios. A maioria dos pacientes retoma suas atividades normais em 2 a 3 dias.
              </p>

              <h2 className="text-2xl font-bold text-[#1A1A1A] mt-10 mb-4">Comparando com outros procedimentos</h2>
              <p className="text-[#666666] leading-relaxed">
                Muitos pacientes se surpreendem ao descobrir que o implante dentário é menos desconfortável do que uma extração simples. Isso ocorre porque a cirurgia é planejada com precisão e realizada de forma minimamente invasiva.
              </p>
